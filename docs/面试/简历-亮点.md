...
where t2.status != 'S'  and t1.product_id in  ('WN-07968', 'HS-FD00050', 'HS-FD00038', 'HS-FD00072', 'HS-FD00252', 'HS-FD00199', 'HS-FD00069', 'HS-FD00254', 'HS-FD00062', 'HS-FD00074', 'HS-FD00222', 'HS-FD00256', 'HS-FD00221', 'HS-FD00278', 'HHC-0285', 'SD-0800001', 'MR-0800001', 'WN-3827', 'WN-07454', 'WN-3043', 'MR-0800002', 'WN-07461', 'WN-3844', 'WN-07970', 'WN-07471', 'WN-07477', 'WN-07512', 'WN-07442', 'WN-07460', 'WN-3820') 
group by t1.product_id  
order by FIELD(t1.product_id,'WN-07968', 'HS-FD00050', 'HS-FD00038', 'HS-FD00072', 'HS-FD00252', 'HS-FD00199', 'HS-FD00069','HS-FD00254', 'HS-FD00062', 'HS-FD00074', 'HS-FD00222', 'HS-FD00256', 'HS-FD00221', 'HS-FD00278', 'HHC-0285', 'SD-0800001', 'MR-0800001', 'WN-3827', 'WN-07454', 'WN-3043', 'MR-0800002', 'WN-07461', 'WN-3844', 'WN-07970', 'WN-07471', 'WN-07477', 'WN-07512', 'WN-07442', 'WN-07460', 'WN-3820' );
```
...
#### 针对关键性的首页一些接口的优化，qps查询提高

1. 修改机器的硬件资源

```json
(erp server)：CPU  4 + Ram 6G + 40G storage
(mobile server1)：CPU  4 + Ram 6G + 40G storage
(mobile server2)：CPU  4 + Ram 6G + 40G storage

Redis 主 CPU2 + Ram 4G +20G storage
Redis 从 CPU2 + Ram 4G +20G storage

db Cluster：  
(master)：mysql max_connections:300，CPU  4 + Ram 4G + 40G storage
(slave)：mysql max_connections:300，CPU  4 + Ram 4G + 40G storage
(slave)：mysql max_connections:300，CPU  4 + Ram 4G + 40G storage
...
2. 使用本地缓存优化代码
3. 优化代码逻辑结构（使用异步任务提高代码执行效率）
4. 优化数据的查询sql、以及修改数据库连接池的最大连接数。

还有一些提高qps的方法，在 **面试题-业务.md** 文件中。具体的优化结果：

![image-20240322150020063](media/images/image-20240322150020063.png)

真实的测试环境优化后的速度：

- getProductMaylike 后面又优化了，访问时间大概为200-500ms以内，大部分200多。
- getProductRanking，稳定200ms左右。
- getWebCategoryProduct，时间200ms左右， 产品目录处点进去。
- searchWebProduct，时间200ms左右。
- getProductBuyAgain，时间200ms以内，大部分100ms内。
- 产品详情页的耗时：200ms以内。相关产品，相关文章，产品评论，价格，你可能喜欢，最近浏览，购物车信息，产品本身介绍信息。
