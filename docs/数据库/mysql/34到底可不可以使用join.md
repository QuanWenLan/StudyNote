...
![image-20211116091908526](media/images/image-20211116091908526.png)
...
由于表 t2 的字段 b 上没有索引，因此再用图 2 的执行流程时，每次到 t2 去匹配的时候，就要做一次全表扫描。（没有用上索引，走全表扫描）
...
![image-20211116094922767](media/images/image-20211116094922767.png)
