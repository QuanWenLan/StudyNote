...
在我本地需要修改，先创建一个 client_tmp 的目录，然后修改命令，在 bin 目录下运行

> mysqldump -h 127.0.0.1 -P 3306 -uroot  --add-locks=0 --no-create-info --single-transaction  --set-gtid-purged=OFF db1 t --where="a>900" --result-file=../client_tmp/t.sql
...
![image-20211206170225759](media/images/image-20211206170225759.png)
...
>  mysql -h 127.0.0.1 -P 3306  -uroot -p123456 db2 -e "source ../client_tmp/t.sql"
...
得到.csv 导出文件后，你就可以用下面的 **load data 命令**将数据导入到目标表 db2.t 中。
...
![image-20211206171036113](media/images/image-20211206171036113.png)
...
![image-20211206171721567](media/images/image-20211206171721567.png)
