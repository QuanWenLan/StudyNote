...
![image-20201110095157479](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20201110095157479.png)

这些命令行工具大多数是`jdk/lib/tools.jar` 类库的一层薄包装而已，他们主要的功能代码是在tools类库中实现的。下面的是`tools.jar`中的内容， 可以对比着看。  

![image-20201110095712559](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20201110095712559.png)
...
![image-20201111171009873](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20201111171009873.png)
...
![image-20201111173834217](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20201111173834217.png)
